...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/admin/plans" element={<PrivateRoute element={<PlansList />} />} />
      <Route path="/admin/plans/:id" element={<PrivateRoute element={<PlanDetails />} />} />
      <Route path="/admin/userlist/:userID" element={<PrivateRoute element={<UserDetails />} />} />
      <Route path="/admin/time" element={<PrivateRoute element={<Time />} />} />
